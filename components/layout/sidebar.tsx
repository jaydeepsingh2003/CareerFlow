            ...
            <nav className="flex-1 overflow-y-auto py-4 px-2 space-y-1">
                {sidebarItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            <item.icon className={cn("h-5 w-5 shrink-0 transition-colors", isActive ? "text-primary" : "text-muted-foreground group-hover:text-white")} />
                    ...
                    <AnimatePresence>
                        {isSidebarOpen && (
                            ...
                            >
                                ...
                                <p className="text-[10px] text-muted-foreground truncate">{user?.email || 'free@plan.com'}</p>
                            </motion.div>
                        )}
                    </AnimatePresence>
                </button>
